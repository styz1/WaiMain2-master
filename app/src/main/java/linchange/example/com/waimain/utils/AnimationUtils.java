...
public class AnimationUtils {
    ...
    public static class Fade {
        ...
        public static void show(final View view) {
            ...
            if (view.getVisibility() != View.VISIBLE || isFadingOut(view)) {
                view.animate().cancel();
                // ...and clearItems the FADE_STATE_KEY tag in case we just
            ...
            if (view.getVisibility() == View.VISIBLE &&
                ...
                view.animate().alpha(0f).setListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        // ...and we're done with the fade-out, so clearItems the view tag.
                        view.setTag(FADE_STATE_KEY, null);
                        if (FADE_DBG) {
                            log("Fade: HIDE " + view
    ...
    /**
     * Drawable achieving cross-fade, just favorite TransitionDrawable. We can have call-backs via
